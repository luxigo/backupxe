...
if [ ! "$INPUT" = "q" -a ! "$INPUT" = "Q"  \
  ...
  for card in \
    3c59x acenic atl1 de4x5 dgrs eepro100 e1000 epic100 hp100 ne2k-pci olympic pcnet32 r8169 rcpci 8139too 8139cp sktr skge sky2 tulip via-rhine yellowfin tg3 dl2k ns83820 \
    ; do
    SKIP=""
