...
netinstallpkg `cat $WORKDIR/packages.list` 2> $ROOT/tmp/netinstallpkg.log || true
reset 2>/dev/null || true
rm $ROOT/usr/doc -r 2>/dev/null || true
rm $ROOT/usr/man -r 2>/dev/null || true
rm $ROOT/usr/include -r 2>/dev/null || true
